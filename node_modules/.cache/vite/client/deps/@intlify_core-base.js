...
function createCompileWarn(code2, loc, ...args) {
  const msg = true ? format(warnMessages[code2] || "", ...args || []) : code2;
...
function createCompileError(code2, loc, options = {}) {
  ...
  const msg = true ? format((messages || errorMessages)[code2] || "", ...args || []) : code2;
...
function getWarnMessage(code2, ...args) {
  return format(warnMessages2[code2], ...args);
}
...
function createCoreError(code2) {
  return createCompileError(code2, null, true ? { messages: errorMessages2 } : void 0);
}
var errorMessages2 = {
...
var compileToFunction = (message, context) => {
  ...
  }
  {
    ...
    const { code: code2, detectError } = baseCompile2(message, context);
...
@intlify/core-base/dist/core-base.mjs:
  (*!
    ...
    *)
*/
//# sourceMappingURL=@intlify_core-base.js.map
