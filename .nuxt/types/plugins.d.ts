...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../plugins/vue3pdf.js")> &
  InjectionType<typeof import("../../plugins/mask.js")> &
  InjectionType<typeof import("../../plugins/gtag.client.js")> &
  InjectionType<typeof import("../../plugins/hotjar.client.js")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:browser-devtools-timing' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'pinia' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | '@nuxt/icon' | 'i18n:plugin:switch-locale-path-ssr' | 'i18n:plugin' | 'nuxt:checkIfLayoutUsed'
  }
}
