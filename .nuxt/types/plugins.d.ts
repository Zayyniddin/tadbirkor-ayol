...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/yandex-metrika-module-nuxt3/dist/runtime/plugin").default> &
  ...
  InjectionType<typeof import("../../plugins/vue3pdf").default> &
  InjectionType<typeof import("../../plugins/mask").default> &
  InjectionType<typeof import("../../plugins/gtag.client").default> &
  InjectionType<typeof import("../../plugins/hotjar.client").default>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:revive-payload:server' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | '@nuxt/icon' | 'i18n:plugin' | 'nuxt:chunk-reload' | 'nuxt:checkIfLayoutUsed'
  }
}
