...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, getQuery as getQuery$1, getRequestURL, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/devalue/index.js';
import destr from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/destr/dist/index.mjs';
import { hash } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/unctx/dist/index.mjs';
import { basename, isAbsolute } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/zayn/Desktop/projects/arcihve/.nuxt/nuxt-icon-server-bundle.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/ipx/dist/index.mjs';
import { unref, version } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/zayn/Desktop/projects/arcihve/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/zayn/Desktop/projects/arcihve/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/Users/zayn/Desktop/projects/arcihve/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/zayn/Desktop/projects/arcihve","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/zayn/Desktop/projects/arcihve/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/zayn/Desktop/projects/arcihve/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/zayn/Desktop/projects/arcihve/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/zayn/Desktop/projects/arcihve/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _waCRfB9OQN = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/zayn/Desktop/projects/arcihve";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _FnxeuqNc37 = (nitroApp) => {
...
const _MEyPYq = defineCachedEventHandler(async (event) => {
...
const _qjHv8z = lazyEventHandler(() => {
...
const _lazy_xTB81H = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_xTB81H, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _MEyPYq, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _qjHv8z, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_xTB81H, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"hid":"description","name":"description","content":"Loyihalar Fabrikasi - Xotin-qizlarning tadbirkorligini yo'lga qo'yish va rivojlantirishini qo'llab quvatlash elektron avxborot tizimi."},{"name":"format-detection","content":"telephone=no"},{"name":"author","content":"«SMART MARKETPLACE» MCHJ"},{"hid":"og-type","property":"og:type","content":"website"},{"hid":"og-site_name","property":"og:site_name","content":"Loyihalar-fabrikasi.uz"},{"hid":"og-title","property":"og:title","content":"Loyihalar-fabrikasi.uz"},{"hid":"og-url","property":"og:url","content":"https://loyihalar-fabrikasi.uz"},{"hid":"og-image","property":"og:image","content":"https://tadbirkor-ayol.uz/services/platon-core/web/v1/store/file/images/bwlogo.svg"},{"hid":"og-description","property":"og:description","content":"Loyihalar-fabrikasi.uz - Xotin-qizlarning tadbirkorligini yo'lga qo'yish va rivojlantirishini qo'llab quvatlash elektron avxborot tizimi."},{"property":"keywords","content":"Loyihalar, Fabrika, loyihalar fabrikasi, biznes rejalar"}],"link":[{"rel":"icon","type":"image/x-icon","href":"https://tadbirkor-ayol.uz/services/platon-core/web/v1/store/file/images/bwlogo.svg"}],"style":[],"script":[],"noscript":[],"title":"Loyihalar Fabrikasi","viewport":"width=device-width, initial-scale=1"};
...
const getClientManifest = () => import('file:///Users/zayn/Desktop/projects/arcihve/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
