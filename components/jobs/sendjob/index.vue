<template>
  <el-form
    ...
    <div class="flex flex-col gap-4">
      ...
      <el-form-item label="Telfon raqam" prop="name">
        <el-input v-model="ruleForm.name" />
      </el-form-item>
      <el-form-item label="Resumeni yuklash" prop="name">
        <div class="flex items-center gap-4 w-full">
          <label
            for="file"
            class="border border-[#e9e9e9] max-w-[200px] w-full relative px-4 py-2 h-[42px] flex items-center gap-2 justify-center  rounded-lg">
