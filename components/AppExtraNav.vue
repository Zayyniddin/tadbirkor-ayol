<template>
  <div class="w-full bg-[#E6F9F8]">
    <nav
      class="w-full px-3 py-3 flex items-center justify-center top-0 left-0 z-[200] h-20"
      :class="scrollY > 120 ? 'fixed bg-[#E6F9F8]' : ''">
        ...
        <div class="flex items-center gap-16">
          <div class="flex items-center gap-3">
            ...
            <nuxt-link :to="localePath(`/`)">
              <!-- <img class="h-8 max-md:h-6" src="@/assets/images/bwlogo.svg" /> -->
          ...
          <div
            ...
            <div class="flex items-center max-md:flex-col">
              <!-- <nuxt-link :to="localePath(`/consulting`)" class="text-gray-700 group">
                <div class="p-2" @click="toggle = false">
                  <span
                    class="text-gray-700 group-[.router-link-exact-active]:text-green-600">
                    Konsalting
                  </span>
                </div>
              </nuxt-link> -->
              <!-- <nuxt-link
                ...
                <div class="p-2" @click="toggle = false">
                  <span class=""> Bo’sh ish o’rinlari </span>
                </div>
              </nuxt-link> -->
              <nuxt-link
                ...
                class="text-gray-700  group">
                <div class="p-2" @click="toggle = false">
                  <span class="text-gray-700 group-[.router-link-exact-active]:text-green-600"> Ta’lim </span>
                </div>
              </nuxt-link>
              ...
              <nuxt-link
                ...
                class="text-gray-700  group">
                <div class="p-2" @click="toggle = false">
                  <span class="text-gray-700 group-[.router-link-exact-active]:text-green-600"> Ish o’rinlari </span>
                </div>
              </nuxt-link>
              <nuxt-link
                :to="localePath(`/news`)"
                class="text-gray-700  group">
                <div class="p-2" @click="toggle = false">
                  <span class="text-gray-700 group-[.router-link-exact-active]:text-green-600"> Yangiliklar </span>
                </div>
              </nuxt-link>
             <!-- <nuxt-link
                :to="localePath(`/calc`)"
                class="text-gray-700  group">
                <div class="p-2" @click="toggle = false">
                  <span class="text-gray-700 group-[.router-link-exact-active]:text-green-600"> Kredit Kalkulyatori </span>
                </div>
              </nuxt-link> -->
               ...
               <nuxt-link
                ...
                class="text-gray-700  group">
                <div class="p-2" @click="toggle = false">
                  <span class="">Savol va takliflar</span>
                </div>
              </nuxt-link>
              ...
              <nuxt-link
                ...
                class="text-gray-700  group">
                <div class="p-2" @click="toggle = false">
                  <span class="text-gray-700 group-[.router-link-exact-active]:text-green-600"> Mahsulot va xizmat sotish </span>
                </div>
              </nuxt-link>
            </div>
          </div>
