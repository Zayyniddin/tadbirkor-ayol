          ...
          <div
            ...
            <div class="flex items-center max-md:flex-col">
              ...
              <nuxt-link
                ...
                <div class="p-2" @click="toggle = false">
                  <span class="group-[.router-link-exact-active]:text-green-600"> Ta’lim </span>
                </div>
              </nuxt-link>
              ...
              <nuxt-link
                ...
                class="text-gray-700  group">
                <div class="p-2" @click="toggle = false">
                  <span class="group-[.router-link-exact-active]:text-green-600"> Ish o’rinlari </span>
                </div>
              </nuxt-link>
              <nuxt-link
                :to="localePath(`/news`)"
                class="text-gray-700  group">
                <div class="p-2" @click="toggle = false">
                  <span class="group-[.router-link-exact-active]:text-green-600"> Yangiliklar </span>
                </div>
              </nuxt-link>
              <nuxt-link
                ...
                class="text-gray-700  group">
                <div class="p-2" @click="toggle = false">
                  <span class="group-[.router-link-exact-active]:text-green-600">Savol va takliflar</span>
                </div>
              </nuxt-link>
               ...
               <nuxt-link
                ...
                class="text-gray-700  group">
                <div class="p-2" @click="toggle = false">
                  <span class=""> Mahsulot va xizmat sotish </span>
                </div>
              </nuxt-link>
            </div>
          </div>
